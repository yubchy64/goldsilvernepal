  ...
  return (
    <div className="card p-5 sm:p-6 h-full flex flex-col">
      <div className="flex items-center gap-2.5 mb-5">
        ...
        <h3 className="text-lg font-semibold text-gray-900 tracking-tight">Calculator</h3>
      </div>

      <div className="flex flex-col gap-5 flex-grow">
        {/* Metal Selection - Pill style */}
        <div role="group" aria-label="Select metal type" className="flex p-1 bg-gray-100 rounded-xl">
          <button
        ...
        <div className="flex gap-3">
          <div className="flex-grow">
            <label htmlFor="quantity" className="block text-xs font-medium text-gray-500 mb-1.5 ml-1">Quantity</label>
            <input
              id="quantity"
              type="number"
              min="0"
              ...
              className="input w-full px-4 py-3 text-gray-900 placeholder-gray-400"
              placeholder="0.00"
          ...
          <div className="w-24">
             <label htmlFor="unit" className="block text-xs font-medium text-gray-500 mb-1.5 ml-1">Unit</label>
            <select
              id="unit"
              value={unit}
              onChange={(e) => setUnit(e.target.value as 'Tola' | 'Gram')}
              className="input w-full px-4 py-3 text-gray-900"
            >
        ...
        {/* Result */}
        <div className="bg-white/50 backdrop-blur-md rounded-2xl p-5 border border-white flex flex-col items-center justify-center text-center mt-auto shadow-sm">
            <span className="text-xs font-medium text-gray-500 mb-1">Estimated Total</span>
            <span className="text-2xl sm:text-3xl font-semibold text-gray-900 tracking-tight break-all">
